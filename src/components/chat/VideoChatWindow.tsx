  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col bg-gray-900">
      ...
      <div className="relative flex-1 min-h-0 w-full">
        ...
        />
        {/* When no remote stream yet, show local as main */}
        <video
        ...
        {/* PiP – local video in top-right, MSN-style rounded */}
        ...
        {/* Volume indicator – left side, MÄÄK style */}
        <div className="absolute left-4 bottom-24 z-10 flex flex-col items-center gap-1 rounded-full bg-black/40 px-2 py-2">
