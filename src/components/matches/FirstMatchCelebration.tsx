  ...
  const tips = [
    {
      ...
      text: "Personlighetsmatchning handlar om djupare förståelse",
    },
    {
      icon: <Heart className="h-4 w-4" />,
      text: "Vårt system väljer både liknande och kompletterande personligheter",
    },
    {
      icon: <Sparkles className="h-4 w-4" />,
      text: "Använd AI-isbrytare för att starta samtalet",
    },
  ];
