            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                {evidenceFiles.length < 5 && (
                  <label htmlFor="report-evidence-files" className="inline-flex items-center gap-1.5 px-3 py-2 rounded border border-dashed border-muted-foreground/40 text-sm cursor-pointer hover:bg-muted/50">
