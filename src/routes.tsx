...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: "admin/appeals", element: <AdminAppeals /> },
      { path: "group-chat", element: <GroupChatList /> },
      { path: "group-chat/create", element: <CreateGroupChat /> },
      { path: "group-chat/:groupId", element: <GroupChatWindow /> },
