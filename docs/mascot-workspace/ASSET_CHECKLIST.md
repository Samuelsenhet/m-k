...
- [x] mascot_calm_idle.png
- [x] mascot_ai_listening.png
- [x] mascot_ai_thinking.png
- [x] mascot_ai_open_hand.png
- [x] mascot_ai_tiny_sparkle.png
- [x] mascot_waiting_tea.png
- [x] mascot_planting_seed.png
- [x] mascot_practicing_mirror.png
- [x] mascot_lighting_lantern.png

## Optional (built from above)

- [x] mascot_sheet_ai.png – Built by `npm run mascot:sprite` from the four `mascot_ai_*.png` files. If you updated any AI token, run the script after replacing those PNGs.
